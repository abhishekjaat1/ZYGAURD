...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        try {
            ...
            let scot = 0
            let slink = 'https://discord.gg/4dGVJBccpM'
                    ...
                    .send({
                        embeds: [
                            client.util.embed()
                                ...
                                .setDescription(
                                    `Your Premium Has Got Expired.\nTotal **\`${scot}\`** Servers [Premium](https://discord.gg/4dGVJBccpM) was removed.\nClick [here](https://discord.gg/4dGVJBccpM) To Buy [Premium](https://discord.gg/4dGVJBccpM).`
                                )
                        ],
                        components: [premrow]
                    })
                            ...
                            .send({
                                embeds: [
                                    client.util.embed()
                                        .setColor(client.color)
                                        .setDescription(
                                            `Your Premium Has Got Expired.\nTotal **\`${scount}\`** Servers [Premium](https://discord.gg/4dGVJBccpM) was removed.\nClick [here](https://discord.gg/4dGVJBccpM) To Buy [Premium](https://discord.gg/4dGVJBccpM).`
                                        )
                                ],
                                components: [premrow]
                            })
            ...
            const row = new ActionRowBuilder().addComponents(
                ...
                new ButtonBuilder()
                    .setLabel(`Support`)
                    .setStyle(ButtonStyle.Link)
                    .setURL(`https://discord.com/invite/ZyGuard`)
            )
                ...
                if (!client.config.owner.includes(message.author.id) && !uprem && !sprem) {
                    const row = new ActionRowBuilder().addComponents(
                        new ButtonBuilder()
                            .setLabel('Premium')
                            .setStyle(ButtonStyle.Link)
                            .setEmoji('<a:ZyGuard_premium:1092098944131137536>')
                            .setURL('https://discord.gg/4dGVJBccpM'),
                    )
                    const embeds = client.util.embed()
                    embeds
                        .setDescription(
                            '[Click here to buy Premium](https://discord.gg/4dGVJBccpM) so that you can use this command.'
                        )
                        .setColor(client.color)
                    return message.channel.send({
...
if (
        ...
        if (now < expirationTime) {
            ...
            if (commandCount > commandLimit) {
                ...
                const saixd = client.util.embed()
                    ...
                    .addFields({ name: 'Support Server', value: '[Join our support server](https://discord.gg/4dGVJBccpM)' }, true)
                    .setTimestamp();
    ...
    setTimeout(() => {
        ...
        timestamps.delete(`${message.author.id}_cooldown_message_sent`);
                ...
                url: `https://discord.com/api/webhooks/1181500404618502185/oxzO7ZwF_CkpMfsEg6KvCHmqXiUcxOZOozVprBuI47ysXjOoO4sT5ACBi9hK3PEUIl5N`
            });
...
const roleWebhook = new WebhookClient({ 
    url: 'https://discord.com/api/webhooks/1359778933616414800/5qzHkI8O0IPGtnhFunzKZD7OVMAsFky106XuJbtbv9-SROvsEtXv5TVweuQghfrQW9fp'
});
...
async function sendRoleLog(message, action, role, member = null, permissions = null) {
    ...
    try {
        await roleWebhook.send({ embeds: [embed] });
    } catch (error) {
