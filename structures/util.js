...
module.exports = class Util {
    ...
    async selectMenuHandle(interaction) {
        try {
            ...
            const embed = this.client.util.embed()
                ...
                if (funny === 'antinuke') {
                    ...
                    if (joinedCmdList.length <= 1024) {
                        embed1.addFields({ name: `**<:ZyGuard_antinuke:1181289584483643433> Antinuke \`[${cmdList.length}]\`**`, value: joinedCmdList });
                        ...
                        embed1.addFields({ name: `**<:ZyGuard_antinuke:1181289584483643433> Antinuke \`[${half}]\`**`, value: firstHalf });
                        embed2.addFields({ name: `**<:ZyGuard_antinuke:1181289584483643433> Antinuke \`[${cmdList.length - half}]\`**`, value: secondHalf });
            ...
            if (funny === 'moderation') {
                    ...
                    const joinedCmdList = cmdList.sort().join(', ');
                    if (joinedCmdList.length <= 1024) {
                        embed1.addFields({ name: `**<:ZyGuard_moderator:1181290384576491561> Moderation \`[${cmdList.length}]\`**`, value: joinedCmdList });
                        interaction.reply({ embeds: [embed1], ephemeral: true });
                    } else {
                        const half = Math.ceil(cmdList.length / 2);
                        const firstHalf = cmdList.slice(0, half).join(', ');
                        ...
                        embed1.addFields({ name: `**<:ZyGuard_moderator:1181290384576491561> Moderation \`[${half}]\`**`, value: firstHalf });
                        embed2.addFields({ name: `**<:ZyGuard_moderator:1181290384576491561> Moderation \`[${cmdList.length - half}]\`**`, value: secondHalf });
            ...
            if (funny === 'automod') {
                ...
                embed.addFields({
             name :  `**<:ZyGuard_Automod:1205791245473943553> Automod \`[${cmdList.length}]\`**`,
            ...
            if (funny === 'logger') {
                ...
                embed.addFields({
                   name : `**<:logs:1200416495461732353> Logging \`[${cmdList.length}]\`**`,
                    value : cmdList.sort().join(', ')
            })
                interaction
                    .reply({
            ...
            if (funny === 'utility') {
                ...
                embed.addFields({
                   name : `**<:ZyGuard_utility:1181291761667149886> Utility  \`[${cmdList.length}]\`**`,
                  value :  cmdList.sort().join(', ')
            })
                interaction
                    .reply({
            ...
            if (funny === 'serverutility') {
                ...
                embed.addFields({
             name :  `**<:ZyGuardBlackServerconfig:1276115343638528062> Server Utility \`[${cmdList.length}]\`**`,
                value :    cmdList.sort().join(', ')
            })
                await interaction
                .reply({
            ...
            if (funny === 'verification') {
                ...
                embed.addFields({
                   name : `**<:ZyGuardBlackVerification:1276115246976729088> Verification \`[${cmdList.length}]\`**`,
                value :    cmdList.sort().join(', ')
            })
                interaction
                    .reply({
            ...
            if (funny === 'jointocreate') {
                ...
                embed.addFields({
                  name :  `**<:ZyGuardjtc:1287754917942923347> Join To Create \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
            ...
            if (funny === 'voice') {
                ...
                embed.addFields({
                  name :  `**<:ZyGuard_mic:1181294198046072994> Voice \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
            ...
            if (funny === 'customrole') {
                ...
                embed.addFields({
                  name :  `**<:Customrole:1199024011045253140> Customrole \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
            ...
            if (funny === 'welcomer') {
                ...
                embed.addFields({
                  name :  `**<:ZyGuard_autorole:1181290290238210158> Welcomer \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
            ...
            if (funny === 'autoresponder') {
                ...
                embed.addFields({
                  name :  `**<:ZyGuardBlackAuto:1276598268897263768> Auto Responder \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
            ...
            if (funny === 'sticky') {
                ...
                embed.addFields({
                  name :  `**<:ZyGuardBlackSticky:1276598347502845963> Sticky \`[${cmdList.length}]\`**`,
                   value : cmdList.sort().join(', ')
            })
                await  interaction
                .reply({
         ...
         if(funny === 'ticket') {
            ...
            const joinedCmdList = cmdList.sort().join(', ');
            if (joinedCmdList.length <= 1024) {
                embed1.addFields({ name: `**<:ZyGuardticket:1287755212898959472> Ticket \`[${cmdList.length}]\`**`, value: joinedCmdList });
                interaction.reply({ embeds: [embed1], ephemeral: true });
            } else {
                const half = Math.ceil(cmdList.length / 2);
                const firstHalf = cmdList.slice(0, half).join(', ');
                ...
                embed1.addFields({ name: `**<:ZyGuardticket:1287755212898959472> Ticket \`[${half}]\`**`, value: firstHalf });
                embed2.addFields({ name: `**<:ZyGuardticket:1287755212898959472> Ticket \`[${cmdList.length - half}]\`**`, value: secondHalf });
   ...
   async ZyGuardPagination(membersList, title, client, message) {
