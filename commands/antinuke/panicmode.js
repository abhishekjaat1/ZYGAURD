module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const antinuke = client.util.embed()
            ...
            .setDescription(`ZyGuard's Panic Mode is an advanced defense system crafted to counter scripted or automated mass nuke/raid attacks on server. Panic Mode fortifies defenses, protecting your server against mass nuke`)
            .addFields([
                {
