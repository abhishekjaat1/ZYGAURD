...
const totalCount = row1 ? row1.count : 0; // Fallback to 0 if row is undefined
        ...
        const embed = client.util.embed()
            ...
            .setURL('https://discord.gg/4dGVJBccpM')
            .setAuthor({
                name: client.users.cache.get('1180425876798701588').globalName,
                iconURL: client.guilds.cache.get('873228243757596672')?.members?.cache?.get('1180425876798701588')?.user?.displayAvatarURL({ dynamic: true })
            })
            .setDescription(
            ...
            if (i.isButton()) {
                ...
                if (i.customId == 'partners') {
                    ...
                    const em = client.util.embed()
                        ...
                        .setImage('https://media.discordapp.net/attachments/1152257911033168042/1171351266149015592/standard_1.gif?width=585&height=75');
                ...
                if (i.customId == 'team') {
                    ...
                    let user = await client.users.fetch('1180425876798701588'); //terminator
                    dev.push(`[${user.username}](https://discord.com/users/1180425876798701588)`);
                    user = await client.users.fetch('1187775437624053770'); //satyam
                    dev.push(`[${user.username}](https://discord.com/users/1187775437624053770)`);

                    user = await client.users.fetch('902363493242650635'); //sumit
                    cteam.push(`[${user.username}](https://discord.com/users/902363493242650635)`);
                    user = await client.users.fetch('775333233335205918'); //adi
                    cteam.push(`[${user.username}](https://discord.com/users/775333233335205918)`);

                    user = await client.users.fetch('855690571535876157'); //flame
                    supe.push(`[${user.username}](https://discord.com/users/855690571535876157)`);
                    user = await client.users.fetch('1061393929473359922'); //samppth
                    supe.push(`[${user.username}](https://discord.com/users/1061393929473359922)`);
                    user = await client.users.fetch('1198321215618695250'); //saket
                    supe.push(`[${user.username}](https://discord.com/users/1198321215618695250)`);
                    ...
                    const em = client.util.embed()
                        ...
                        .addFields([
                            ...
                            { name: `**__Core Team__**`, value: cteam.join(', ') },
                            { name: `**__Superintendent__**`, value: supe.join(', ') }
                        ])
                        .setFooter({
                            text: `Requested By ${message.author.tag}`,
                            iconURL: message.author.displayAvatarURL({ dynamic: true })
                        ...
                        msg.edit({
                            embeds: [
                                client.util.embed()
                                    ...
                                    .setDescription(
                                        '<:ZyGuard_mainrole:1181290802022977576> | **Fetching** all the **resources**...'
                                    )
                            ],
                            components: [row]
                        })
