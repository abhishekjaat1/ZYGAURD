...
//const ZyGuardPagination = require('./ZyGuardPagination'); // Assuming your pagination function is in this file
...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        client.util.ZyGuardPagination(membersList, title, client, message);
    }
};